...
Поведінку Базіки задають саме ці файли:
...
`README.md` — довідковий файл для людини; він описує workspace, але не формує поведінку Базіки напряму.

Зміни в `SOUL.md`, `IDENTITY.md` і `USER.md` у цьому workspace підхоплюються автоматично.
