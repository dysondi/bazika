...
`README.md` — довідковий файл для людини; він не формує поведінку агента напряму.

Саме `SOUL.md`, `IDENTITY.md` і `USER.md` задають роль, стиль і фокус Базіки. Зміни в цих файлах у цьому workspace підхоплюються автоматично.
