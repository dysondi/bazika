...
`README.md` — лише довідковий файл для людини; він не задає поведінку агента напряму.

Тобто якщо хочеш змінити відповіді Базіки, редагуй `SOUL.md`, `IDENTITY.md` або `USER.md`, а не `README.md`.
